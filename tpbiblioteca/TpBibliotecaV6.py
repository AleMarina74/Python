        ...
        try:
            ...
            if Tipo == 'Modif':
                if Nombre2 == '':
                    ...
                    if longNomAnt == 2 or longNomAnt == 4:
                        break
                    else:
                        if Confirmacion(f'El {AntNom2App} es su Apellido? S/N'):
                            AntApellido2 = AntApellido
...
while Opcion != 4:
    if Opcion == 0:
                ...
                if BusquedaCliente[0] == 'S':
                    with open('Clientes.txt', 'r+', encoding="utf-8") as rwClientes:
                        ...
                        if renglon[4] == 'D':
                            ...
                            RegistroMod = ClienteDni + ',' + modNombre + ',' + modTelefono + ',' + modDomicilio + ',' + renglon[4] + ',' + renglon[5] + ' \n'
        ...
        if OpcionLibro == 0:
            ...
            print(f'{CambioColor(Normal, Blanco)}')
            TituloConsultar = IngresarTitulo('Cual es el Titulo del Libro que desea Modificar o palabra clave?','Consulta',' ')
            OpcionTitulo = BuscoRegistro('Libros.txt', TituloConsultar, 1)
            if OpcionTitulo[0] == 'E' or OpcionTitulo[0] == 'N':
                print('\033[1;36m')
                ...
                with open('Libros.txt', 'r+', encoding="utf-8") as rwLibros:
                    ...
                    if renglon[3] == 'D':
                        ...
                        RegistroMod = LibroISBN + ',' + modTitulo + ',' + modAutor + ',' + renglon[3] + ',' + renglon[4] + ' \n'
